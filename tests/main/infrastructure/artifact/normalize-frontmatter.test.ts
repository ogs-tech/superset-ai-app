...
import { normalizeArtifactFrontmatter } from '../../../../src/main/infrastructure/artifact/normalize-frontmatter.js';

describe('normalizeArtifactFrontmatter — legacy scope migration', () => {
  it('converts legacy scope: "personal" into scopes: ["personal"]', () => {
    ...
    const result = normalizeArtifactFrontmatter(legacy);
  ...
  it('preserves new-format scopes when already present', () => {
    ...
    const result = normalizeArtifactFrontmatter(fresh);
  ...
  it('prefers scopes when both legacy scope and scopes are present', () => {
    ...
    const result = normalizeArtifactFrontmatter(both);
  ...
  it('falls back to empty array when neither field is present', () => {
    ...
    const result = normalizeArtifactFrontmatter(neither);
